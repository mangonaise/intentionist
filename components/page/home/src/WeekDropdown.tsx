...
import { Flex, Icon, IconButton, Text } from '@/components/primitives'
import { ArrowRightIcon, CheckIcon, ChevronLeftIcon, ChevronRightIcon } from '@/components/icons'
import { addMonths, eachWeekOfInterval, endOfMonth, lightFormat, isFuture, isSameDay, isSameMonth, isSameWeek, startOfMonth, subWeeks } from 'date-fns'
...
const WeekDropdown = observer(() => {
  ...
  if (startDate === formatYYYYMMDD(thisWeekStartDate)) {
    ...
    title = `Week of ${lightFormat(new Date(startDate), 'd MMM yyyy')}`
  }
